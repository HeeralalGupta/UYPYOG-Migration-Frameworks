...
@Service
public class ContractorExcelReader {
    ...
    private static final int COL_CONTRACTOR_NAME = 2;
    ...
    private static final int COL_CONTRACTOR_TYPE = 15;
    ...
    public List<ContractorRecord> read(MultipartFile file) {
        ...
        try (InputStream inputStream = file.getInputStream();
            ...
            throw new RuntimeException(
                    "Unable to read Contractor Excel file.", e);
        }
     ...
     * =========================================================
     */
    private ContractorRecord createContractorRecord(Row row) {
         ...
         * Permanent Address
         *
         * Your Contractor entity has paymentAddress,
         * so map Permanent Address to paymentAddress.
         */
    ...
    private String getCellValue(
        ...
        case NUMERIC:
             ...
             * Important:
             *
             * Bank account, mobile, PAN, GST etc.
             * should preferably be stored as Text in Excel.
             *
             * For numeric cells, this prevents values such
             * as 3.2549E+11 where possible.
             */
