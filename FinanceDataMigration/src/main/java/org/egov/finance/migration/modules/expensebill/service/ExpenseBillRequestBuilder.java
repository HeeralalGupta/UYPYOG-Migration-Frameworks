...
//		}
//
//		System.out.println("================ BILL DETAILS DEBUG ================");
////		System.out.println("Total Bill Details Count: " + billDetails.size());
////		System.out.println("---------------- DEBIT DETAILS ----------------");
////
////		billDetails.stream().filter(detail -> detail.getDebitamount() != null)
////				.forEach(detail -> System.out.println("GL Code ID: " + detail.getGlcodeid() + " | Debit Amount: "
////						+ detail.getDebitamount() + " | Credit Amount: " + detail.getCreditamount()));
////
////		System.out.println("---------------- CREDIT DETAILS ----------------");
////
////		billDetails.stream().filter(detail -> detail.getCreditamount() != null)
////				.forEach(detail -> System.out.println("GL Code ID: " + detail.getGlcodeid() + " | Debit Amount: "
////						+ detail.getDebitamount() + " | Credit Amount: " + detail.getCreditamount()));
////
////		System.out.println("---------------- TOTALS ----------------");
////
////		BigDecimal totalDebit = billDetails.stream().map(EgBilldetails::getDebitamount).filter(Objects::nonNull)
////				.reduce(BigDecimal.ZERO, BigDecimal::add);
////
////		BigDecimal totalCredit = billDetails.stream().map(EgBilldetails::getCreditamount).filter(Objects::nonNull)
////				.reduce(BigDecimal.ZERO, BigDecimal::add);
////
...
//		try {
//
//			String requestJson = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(billDetails);
//
//			System.out.println();
//			System.out.println("==========================================================");
//			System.out.println("        EXPENSE BILL REGISTER JSON");
